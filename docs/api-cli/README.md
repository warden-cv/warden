# Warden functional API and CLI

Phase 5 certifies **73 declared operations**, with **72 website-used operations** and **70 observed CLI mappings**. The authoritative generated statement is [`../generated/functional-coverage.md`](../generated/functional-coverage.md); CI checks it byte-for-byte against the tested manifest.
