...
assert(css.includes('.monitor-layout .primary-metric #cpu-chart{top:130px') && css.includes('.monitor-layout .network-metric .metric-spark{top:130px'), 'all metric charts must share aligned top bounds and equal text clearance');
