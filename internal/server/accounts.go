...
var capabilityCatalog = []capabilityInfo{
	{Key: "monitor.read", Group: "Workspace", Label: "View monitoring"},
	{Key: "files.read", Group: "Workspace", Label: "Browse/read files"},
	{Key: "files.write", Group: "Workspace", Label: "Create/edit/upload files"},
	{Key: "files.manage", Group: "Workspace", Label: "Move/copy/delete/archive files"},
	{Key: "workspace.search", Group: "Editor", Label: "Search workspaces"},
	{Key: "workspace.replace", Group: "Editor", Label: "Replace across workspaces"},
	{Key: "source.read", Group: "Source control", Label: "View Git status"},
	{Key: "source.write", Group: "Source control", Label: "Stage/unstage/commit"},
	{Key: "terminal.open", Group: "Terminal", Label: "Open interactive terminal"},
	{Key: "system.read", Group: "System", Label: "View system administration pages"},
	{Key: "system.manage", Group: "System", Label: "Change system services/settings"},
	{Key: "accounts.manage", Group: "Warden", Label: "Manage Warden accounts and roles"},
	{Key: "roles.manage", Group: "Warden", Label: "Manage roles and capability assignments"},
	{Key: "launcher.configure.self", Group: "Launcher", Label: "Manage own launcher additions"},
	{Key: "launcher.configure.all", Group: "Launcher", Label: "Manage shared launcher catalogue"},
	{Key: "launcher.propagate", Group: "Launcher", Label: "Propagate launcher catalogue to trusted Warden peers"},
	{Key: "settings.manage", Group: "Warden", Label: "Manage instance configuration"},
	{Key: "audit.read", Group: "Warden", Label: "View Warden audit history"},
	{Key: "ai.use", Group: "AI", Label: "Use AI providers"},
	{Key: "agent.run", Group: "AI", Label: "Run coding agent"},
	{Key: "ai.credentials", Group: "AI", Label: "Manage own AI credentials"},
	{Key: "ai.manage", Group: "AI", Label: "Manage shared AI provider configuration"},
}
